...
import uz.gita.mytodoappwithdagger.databinding.DialogAppEventBinding


class EventAppDialog : BottomSheetDialogFragment() {
    private var _viewBinding : DialogAppEventBinding?= null
    ...
    override fun onCreateView(
        ...
        _viewBinding = DialogAppEventBinding.inflate(inflater, container, false)
